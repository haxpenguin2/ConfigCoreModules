...
# Fully compatible with CoreGUI

import sys
import os

# Ensure the core folder is in path for config_core import
core_path = os.path.expanduser("~/GUIconfigcore")
...
try:
    ...
    raise ImportError("config_core.py not found. Make sure it exists in your core path.")
...
class EditorWidget(QWidget):
    ...
    def save_config(self):
        # Convert all values to proper string format for config
